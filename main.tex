...
\category{Full version with appendix of an ICALP 2023 Track B paper} %optional, e.g. invited paper

\relatedversiondetails{Conference proceedings}{https://doi.org/10.4230/LIPIcs.ICALP.2023.117} %optional, e.g. full version hosted on arXiv, HAL, or other respository/website
...
\acknowledgements{We thank the reviewers for helpful suggestions on the presentation of the paper.}%optional
