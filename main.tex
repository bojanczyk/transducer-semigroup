...
\category{Track B: Automata, Logic, Semantics, and Theory of Programming} %optional, e.g. invited paper

\relatedversiondetails{Full version with appendices}{https://hal.science/hal-03985883} %optional, e.g. full version hosted on arXiv, HAL, or other respository/website
...
\acknowledgements{We thank the reviewers for suggestions that helped improve the
presentation of the paper.}%optional
...
\input{ap-reco-reflecting}
\input{ap-synt-copyless}
\input{ap-merge-factorized-output}
