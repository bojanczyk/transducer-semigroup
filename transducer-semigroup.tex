...
\begin{remark}\label{rem:parametricity}
  ...
  Then \kl{naturality} of the output mechanism expresses that, being defined
...
two classes of functions: all functions (Theorem~\ref{thm:all-functions}) and string-to-string functions that reflect \kl{recognizability} (Theorem~\ref{thm:reco-reflecting-functions}).
