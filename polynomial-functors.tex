...
\tito{update normalization looks like the coproduct $A \oplus \bigoplus_{X\in R} \{X\}^+$ --- should we mention that?}
...
\tito{Cut all sentences but the first one and refer to the conclusion for discussion instead?}
