...
The crucial property of semigroups that will be used in our proof is \Cref{prop:views} below, which says that an element of a coproduct can be reconstructed based on certain partial information. This information is described  using the following operations.
