...
\AP When $\functor$ and $\functorg$ are \kl{polynomial functors}, it will be
convenient to speak of \intro{natural functions} (resp.\ \intro{copyless natural
  functions}) to refer to functions $f\colon \functor A \to \functorg A$ that
can be extended to \kl{natural} (resp.\ copyless natural) transformations
