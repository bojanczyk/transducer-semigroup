\section{Proof of Theore~\ref{thm:reco-reflecting-functions}}
    ...
    \santa{I believe that it does not hold. Take $C$ to be the two element group, and $B= C^\omega$. For this reason, I made all theorems into string-to-string functions, so that there are no annoying subtle changes in their statements.}
