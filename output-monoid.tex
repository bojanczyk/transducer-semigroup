...
\begin{lemma}\label{lem:compute-next-configuration}
    ...
    \begin{align*}
    \tuple{wa|\underline v}  = \delta_A(\tuple{w|\underline{av}}, g(w,a,v)).
    \end{align*}
\end{lemma}
\begin{proof}
    ...
    Using Lemma~\ref{lem:views}, we have a natural bijection of polynomial functors
    \[ ((A \oplus A) + \functorj A) \oplus 1 \cong ((A \oplus 1) \times (1 \oplus A)) \oplus 1 \]
    \tito{TODO}
...
\end{align*}
that was discussed in Example~\ref{ex:coproduct-as-polynomial-functor}. If we apply this isomorphism to an element of the form
\begin{align*}
