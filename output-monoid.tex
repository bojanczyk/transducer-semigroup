...
\tito{strictly speaking \Cref{ex:squaring} is not of type $\Sigma^*\to\Gamma^*$}
...
\footnotetext{More precisely, consider the following diagram, where the upper path describes the composition of two functions recognized transducer semigroups $(\functor,\outfun)$ and $(\functor',\outfun')$, respectively:
    \[
...
\tito{The concept of \enquote{part} of a value in a semigroup might be unclear}
