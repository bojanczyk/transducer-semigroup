...
immediate, this proves \Cref{thm:regular-functions}.
...
\begin{proof}
  ...
  More precisely, consider the following commuting \kl{naturality} diagram:
    \[
...
\subparagraph*{Proof of $(\ref{it:trans-semig-f1}) \Rightarrow (\ref{it:regular})$ in \Cref{thm:regular-functions}.}
